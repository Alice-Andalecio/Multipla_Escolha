<%-- 
    Document   : perfil
    Created on : 10/07/2017, 23:43:39
    Author     : jaops
--%>

<%@page import="br.cefetmg.dominio.Sessao"%>
<%@page import="br.cefetmg.dominio.Aluno"%>
<%@page import="br.cefetmg.dominio.Questao"%>
...
<!--[if (gte IE 9)|!(IE)]><!--><html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body id="top">
        ...
        <% Sessao sessaoAluno = new Sessao(aluno);%>
        ...
        <section id="process">  
            ...
            <div class="row">
                <div class="col s3">
                    <div>
                        <img src="images/avatars/avatar-6.png" class="circle responsive-img">
                    </div>
                    <a id="nomeUsuario"> <%= request.getAttribute("name")%> </a>
                    <h6 name="apelido" id="apelido"> <%= request.getAttribute("apelido")%> </h6>
                </div>
            ...
            <div class="row">
                <div class="col s3">
                    <p id="emailUsuario"> <%= request.getAttribute("email")%> </p>
                    <h6 id="tipoUsuario"> <%= request.getAttribute("tipoUsuario")%> </h6>
                </div>
